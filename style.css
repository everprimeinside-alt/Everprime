...
.buy-btn {
    ...
    font-style: italic; transition: 0.3s; border: none; cursor: pointer;
    font-size: 17px;
}
...
/* Neon 3D Section Structural Refinement */
.neon-3d-section {
    position: relative;
    width: 100%;
    height: auto; 
...
.neon-3d-section .carousel {
    position: relative;
    width: 100%;
    height: 100%;
    transform-style: preserve-3d;
    animation: rotateCyber 22s infinite linear;
    will-change: transform;
}

.neon-3d-section .item {
    position: absolute;
    left: 50%;
    top: 50%;
    width: 200px;       
    ...
    text-transform: uppercase;
    letter-spacing: 2px;
    background: linear-gradient(135deg, rgba(255, 0, 60, 0.03) 0%, rgba(255, 0, 60, 0.08) 100%);
    border: 1px solid rgba(255, 0, 60, 0.25);
    text-shadow: 0 0 8px #ff003c;
    box-shadow: 0 0 15px rgba(255, 0, 60, 0.1), inset 0 0 10px rgba(255, 0, 60, 0.15);
    backface-visibility: hidden;
    -webkit-box-reflect: below 4px linear-gradient(transparent, rgba(255, 0, 60, 0.08));
}

.neon-3d-section .item::before,
.neon-3d-section .item::after {
    content: '';
    position: absolute;
    width: 8px;
    height: 8px;
...
/* 3D Geometry Transforms using fixed pixel calculations for stability across displays */
.neon-3d-section .item:nth-child(1) { transform: translate(-50%, -50%) rotateY(0deg) translateZ(280px); }
.neon-3d-section .item:nth-child(2) { transform: translate(-50%, -50%) rotateY(60deg) translateZ(280px); }
.neon-3d-section .item:nth-child(3) { transform: translate(-50%, -50%) rotateY(120deg) translateZ(280px); }
.neon-3d-section .item:nth-child(4) { transform: translate(-50%, -50%) rotateY(180deg) translateZ(280px); }
.neon-3d-section .item:nth-child(5) { transform: translate(-50%, -50%) rotateY(240deg) translateZ(280px); }
.neon-3d-section .item:nth-child(6) { transform: translate(-50%, -50%) rotateY(300deg) translateZ(280px); }
...
@media (max-width: 768px) {
    ...
    .neon-3d-section .item:nth-child(1) { transform: translate(-50%, -50%) rotateY(0deg) translateZ(180px); }
    .neon-3d-section .item:nth-child(2) { transform: translate(-50%, -50%) rotateY(60deg) translateZ(180px); }
    .neon-3d-section .item:nth-child(3) { transform: translate(-50%, -50%) rotateY(120deg) translateZ(180px); }
    .neon-3d-section .item:nth-child(4) { transform: translate(-50%, -50%) rotateY(180deg) translateZ(180px); }
    .neon-3d-section .item:nth-child(5) { transform: translate(-50%, -50%) rotateY(240deg) translateZ(180px); }
    .neon-3d-section .item:nth-child(6) { transform: translate(-50%, -50%) rotateY(300deg) translateZ(180px); }
}